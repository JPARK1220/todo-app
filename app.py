...
] = "postgresql://jvyijzue:LNodcYm7SzZ_S2K0-VVPW9EWNIu8YUZQ@berry.db.elephantsql.com/jvyijzue"
...
def swap_task():
    ...
    guest_todo = ToDO.query.filter(
        ToDO.order_index == original_todo.order_index + left_or_right,
        ToDO.user == g.user.id,
    ).first()
